...
exports.returnRandomCharacters = void 0;
...
//     if (typeof inputTime !== 'number') throw new Error('@lawlzer/helpers - sleep: inputTime must be a string representing a number.');
...
// };
// let output = pluck([{ a: 1, b: 2 }, { a: 3, b: 4 }], 'b');
